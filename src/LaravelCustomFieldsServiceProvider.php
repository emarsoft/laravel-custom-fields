    ...
    public function boot()
    {
        ...
        if (!class_exists('CreateCustomFieldsTables')) {
            $this->publishes([
                ...
                __DIR__ . '/../database/migrations/create_custom_field_values_tables.php.stub' => database_path('migrations/' . date('Y_m_d_His', time()) . '_create_custom_field_values_tables.php'),
            ], 'migrations');
        }
